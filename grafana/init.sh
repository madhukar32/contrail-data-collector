...
function waitAndConfigureGrafana
{
    ...
    curl 'http://admin:admin@localhost:3000/api/datasources' \
        ...
        --data-binary '{"name":"influxdb","type":"influxdb","access":"proxy","url":"http://localhost:8086","password":"c0ntrail123","user":"admin","database":"contrail-uve","basicAuth":false,"isDefault":true}'
